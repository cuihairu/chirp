...
const PushNotificationRequest$json = {
  ...
  '2': [
    ...
    {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.chirp.notification.NotificationType', '10': 'type'},
    {'1': 'priority', '3': 3, '4': 1, '5': 14, '6': '.chirp.notification.NotificationPriority', '10': 'priority'},
    ...
    {'1': 'data', '3': 10, '4': 3, '5': 11, '6': '.chirp.notification.PushNotificationRequest.DataEntry', '10': 'data'},
...
final $typed_data.Uint8List pushNotificationRequestDescriptor = $convert.base64Decode(
    'ChdQdXNoTm90aWZpY2F0aW9uUmVxdWVzdBIXCgd1c2VyX2lkGAEgASgJUgZ1c2VySWQSOAoEdH'
    'lwZRgCIAEoDjIkLmNoaXJwLm5vdGlmaWNhdGlvbi5Ob3RpZmljYXRpb25UeXBlUgR0eXBlEkQK'
    'CHByaW9yaXR5GAMgASgOMiguY2hpcnAubm90aWZpY2F0aW9uLk5vdGlmaWNhdGlvblByaW9yaX'
    'R5Ughwcmlvcml0eRIUCgV0aXRsZRgEIAEoCVIFdGl0bGUSEgoEYm9keRgFIAEoCVIEYm9keRIS'
    'CgRpY29uGAYgASgJUgRpY29uEhQKBWltYWdlGAcgASgJUgVpbWFnZRIUCgVzb3VuZBgIIAEoCV'
    'IFc291bmQSEAoDdGFnGAkgASgJUgN0YWcSSQoEZGF0YRgKIAMoCzI1LmNoaXJwLm5vdGlmaWNh'
    'dGlvbi5QdXNoTm90aWZpY2F0aW9uUmVxdWVzdC5EYXRhRW50cnlSBGRhdGESFAoFYmFkZ2UYCy'
    'ABKAVSBWJhZGdlEiEKDGNsaWNrX2FjdGlvbhgMIAEoCVILY2xpY2tBY3Rpb24SFQoGdHRsX21z'
    'GA0gASgDUgV0dGxNcxIhCgxjb2xsYXBzZV9rZXkYDiABKAhSC2NvbGxhcHNlS2V5GjcKCURhdG'
...
const GetUserDevicesResponse$json = {
  ...
  '2': [
    {'1': 'code', '3': 1, '4': 1, '5': 14, '6': '.chirp.common.ErrorCode', '10': 'code'},
    {'1': 'devices', '3': 2, '4': 3, '5': 11, '6': '.chirp.notification.DeviceInfo', '10': 'devices'},
  ],
};
...
final $typed_data.Uint8List getUserDevicesResponseDescriptor = $convert.base64Decode(
    ...
    'Jyb3JDb2RlUgRjb2RlEjgKB2RldmljZXMYAiADKAsyHi5jaGlycC5ub3RpZmljYXRpb24uRGV2'
    'aWNlSW5mb1IHZGV2aWNlcw==');
...
const SilentNotificationRequest$json = {
  ...
  '2': [
    {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
    {'1': 'data', '3': 2, '4': 3, '5': 11, '6': '.chirp.notification.SilentNotificationRequest.DataEntry', '10': 'data'},
...
final $typed_data.Uint8List silentNotificationRequestDescriptor = $convert.base64Decode(
    'ChlTaWxlbnROb3RpZmljYXRpb25SZXF1ZXN0EhcKB3VzZXJfaWQYASABKAlSBnVzZXJJZBJLCg'
    'RkYXRhGAIgAygLMjcuY2hpcnAubm90aWZpY2F0aW9uLlNpbGVudE5vdGlmaWNhdGlvblJlcXVl'
    'c3QuRGF0YUVudHJ5UgRkYXRhEhUKBnR0bF9tcxgDIAEoA1IFdHRsTXMaNwoJRGF0YUVudHJ5Eh'
...
const NotificationPreferences$json = {
  ...
  '2': [
    ...
    {'1': 'channel_settings', '3': 13, '4': 3, '5': 11, '6': '.chirp.notification.NotificationPreferences.ChannelSettingsEntry', '10': 'channelSettings'},
  ],
...
const NotificationPreferences_ChannelSettingsEntry$json = {
  ...
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.chirp.notification.ChannelNotificationSettings', '10': 'value'},
  ],
  '7': {'7': true},
};
...
final $typed_data.Uint8List notificationPreferencesDescriptor = $convert.base64Decode(
    ...
    'b3VyEhkKCGRuZF9kYXlzGAwgAygFUgdkbmREYXlzEmsKEGNoYW5uZWxfc2V0dGluZ3MYDSADKA'
    'syQC5jaGlycC5ub3RpZmljYXRpb24uTm90aWZpY2F0aW9uUHJlZmVyZW5jZXMuQ2hhbm5lbFNl'
    'dHRpbmdzRW50cnlSD2NoYW5uZWxTZXR0aW5ncxpzChRDaGFubmVsU2V0dGluZ3NFbnRyeRIQCg'
    'NrZXkYASABKAlSA2tleRJFCgV2YWx1ZRgCIAEoCzIvLmNoaXJwLm5vdGlmaWNhdGlvbi5DaGFu'
    'bmVsTm90aWZpY2F0aW9uU2V0dGluZ3NSBXZhbHVlOgI4AQ==');
...
const SetPreferencesRequest$json = {
  ...
  '2': [
    {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
    {'1': 'preferences', '3': 2, '4': 1, '5': 11, '6': '.chirp.notification.NotificationPreferences', '10': 'preferences'},
  ],
};
...
final $typed_data.Uint8List setPreferencesRequestDescriptor = $convert.base64Decode(
    'ChVTZXRQcmVmZXJlbmNlc1JlcXVlc3QSFwoHdXNlcl9pZBgBIAEoCVIGdXNlcklkEk0KC3ByZW'
    'ZlcmVuY2VzGAIgASgLMisuY2hpcnAubm90aWZpY2F0aW9uLk5vdGlmaWNhdGlvblByZWZlcmVu'
    'Y2VzUgtwcmVmZXJlbmNlcw==');
...
final $typed_data.Uint8List getPreferencesResponseDescriptor = $convert.base64Decode(
    ...
    'Jyb3JDb2RlUgRjb2RlEk0KC3ByZWZlcmVuY2VzGAIgASgLMisuY2hpcnAubm90aWZpY2F0aW9u'
    'Lk5vdGlmaWNhdGlvblByZWZlcmVuY2VzUgtwcmVmZXJlbmNlcw==');
