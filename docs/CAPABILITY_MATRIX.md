...
| Chat basic messaging | `chirp_chat` | Supported | Private messaging, history, offline queue, and group management (create/join/leave/kick/invite/members) wired into the default binary |
